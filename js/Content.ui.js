                ...
                items: [
                    {
                        ...
                        tpl: [
                            ...
                            '        <table>',
                            '            <tr>',
                            '                <th class="adr-content-item-icon-block">',
                            '                   <div class="adr-content-item-icon-div">',
                            '                    <a href=\'{url}\'>',
                            '                        <img src="{img_url}" class="adr-content-item-icon" onLoad="resizeImage(this, 63);"></img>',
                            '                    </a>',
                            '                    </div>',
                            '                </th>',
                            '                <th class="adr-content-item-description-title">',
                            '                    <a href=\'{url}\' title="{title}">',
                            '                        <h2 class="adr-content-item-title">{[fm.ellipsis(values.title, 75, false)]} </h2>',
                            '                    </a>',
                            '                    <div class="adr-content-item-description">',
                            '                    {[fm.ellipsis(values.description, 255, true)]}',
                            '                    </div>',
                            '                </th>',
                            '            </tr>',
                            '        </table>',
